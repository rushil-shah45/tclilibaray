...
import 'componant/payment_shimmer.dart';
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Future.delayed(const Duration(milliseconds: 500), () {
        controller.emailController.text = Get.find<MainController>().userProfileModel!.email.toString();
        controller.update();
      });
    });
    return Scaffold(
                                    ...
                                    children: [
                                      TableRow(children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            controller.pricingModel.value!.title,
                                            textScaleFactor: 1.1,
                                        ...
                                        Padding(
                                          ...
                                          child: Obx(() => Text(
                                                controller.isSelected.value
                                                    ? 'N${double.parse(controller.pricingModel.value!.priceNgn).toStringAsFixed(2)}'
                                                    : '\$${double.parse(controller.pricingModel.value!.price).toStringAsFixed(2)}',
                                                textScaleFactor: 1.1,
                                                textAlign: TextAlign.end,
                                                maxLines: 1,
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const CustomRichText(title: 'Billing Address ', star: "*"),
                              CustomTextField(
                              ...
                              const CustomRichText(title: 'Billing Zip Code ', star: "*"),
                              CustomTextField(
                              ...
                              SizedBox(height: 2.h),
                              const CustomRichText(title: 'Billing Country ', star: "*"),
                              SizedBox(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: AbsorbPointer(
                                    child: CustomTextField(
                                      controller: controller.billingSelectedCountryController,
                              ...
                              Container(
                                ...
                                child: Obx(() {
                                  return DropdownButton(
                                    padding: EdgeInsets.only(left: 10.w, right: 10.w),
                                    value: controller.userItems.value.contains(controller.userType.value.capitalizeFirst)
                                    ...
                                    items: controller.userItems.value.map((String items) {
                              ...
                              SizedBox(
                                height: controller.isTablet ? Get.height / 19 : Get.height / 17,
                                width: Get.width,
                                child: Stack(
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        showCountryPicker(
                                          ...
                                          onSelect: (Country country) {
                                            controller.dialCode.value = country.phoneCode;
                                            controller.flagIcon.value = country.flagEmoji;
                                            controller.countryCodeName.value = country.countryCode;
                                          },
                                          countryListTheme: CountryListThemeData(
                                            ...
                                            inputDecoration: InputDecoration(
                                              ...
                                              contentPadding: EdgeInsets.only(top: 27.h, left: 10.w, right: 10.w),
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(width: controller.isTablet ? 7.w : 2.w),
                                            Obx(
                                              () => Text(
                                                '+${controller.dialCode.value}',
                                                style: TextStyle(
                                                  color: Colors.black,
                                                  fontSize: controller.isTablet ? 8.sp : 15.sp,
                                                  fontWeight: FontWeight.w500,
                                                ),
                                              ),
                                            ),
                              ...
                              SizedBox(height: 8.h),
                              Visibility(
                                visible: controller.pricingModel.value!.title.compareTo('Free') != 0,
                                child: Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const CustomRichText(title: 'Payment Method ', star: "*"),
                                    // Row(
                                    //   mainAxisAlignment:
                                    ...
                                    Obx(() => GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              color: !controller.isSelected.value ? Colors.blue.withOpacity(0.3) : Colors.white,
                                              borderRadius: BorderRadius.circular(10.r),
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: Image.asset("assets/images/paypal-logo.png", height: Get.height / 20, width: Get.width / 8),
                                                ),
                                                Text(
                                                  "Paypal",
                                                  style: TextStyle(
                                    ...
                                    //                 left: 8.w),
                                    //             child: Image.asset(
                                    //               "assets/images/flutterwave_logo-removebg-preview.png",
                              ...
                              Obx(() => controller.makingPayment.value
                                  ...
                                  : Center(
                                      child: CustomBtn(
                                        ...
                                        callback: () async {
                                          if (controller.pricingModel.value!.title == "Free") {
                                            controller.makeFreePayment();
                                          } else {
                                            if (controller.isSelected.value) {
                                              // controller.makeFlutterWavePayment(
                                              //     context);
                                            } else {
                                              controller.makePaypalPayment('paypal');
                                            }
                                          }
                                        },
                                      ),
