...
class BookForSalePurchasedScreen extends StatefulWidget {
  const BookForSalePurchasedScreen({super.key});

  @override
  State<BookForSalePurchasedScreen> createState() =>
      _BookForSalePurchasedScreenState();
}

class _BookForSalePurchasedScreenState
    extends State<BookForSalePurchasedScreen> {
  var controller = Get.put(AllBookForSaleScreenController());

  @override
  void initState() {
    super.initState();
    controller.getPublisherData();
    controller.getAllBooksPurchasedData();
  }
            ...
            sliver: SliverToBoxAdapter(
              child: Column(
                ...
                children: [
                  CustomTextField(
                    ...
                    suffixIcon: GestureDetector(
                      onTap: () {
                        ...
                        controller.getAllBooksSaleData();
                      },
                      child: const Icon(
                        Icons.clear,
                        color: Colors.grey,
                    ...
                    children: [
                        ...
                        child: GestureDetector(
                          ...
                          child: AbsorbPointer(
                            child: CustomTextField(
                              controller: controller.selectPublisherController,
                      ...
                      SizedBox(
                        ...
                        child: GestureDetector(
                          ...
                          child: AbsorbPointer(
                            child: CustomTextField(
                              controller: controller.selectAuthorController,
                  ...
                  SizedBox(height: 10.h),
                  Obx(
                    () => controller.isLoadingPurchased.value
                        ? SizedBox(
                            width: Get.width,
                        ...
                        : controller.allPurchasedBookList.isEmpty
                            ? Padding(
                                    ...
                                    child: Obx(
                                      () => GridView.builder(
                                        ...
                                        itemCount: controller
                                            .allPurchasedBookList.length,
                                        shrinkWrap: true,
                                        physics:
                                            const NeverScrollableScrollPhysics(),
                                        itemBuilder: (context, index) {
                                          final model = controller
                                              .allPurchasedBookList[index];
                                          return Padding(
