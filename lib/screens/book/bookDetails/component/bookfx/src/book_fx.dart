...
//         /// 翻页
//         _p.value = PaperPoint(
//             Point(widget.currentA.x - (widget.currentA.x + size.width) * _controller!.value,
//                 widget.currentA.y + (size.height - widget.currentA.y) * _controller!.value),
//             size);
//       } else {
//         /// 不翻页 回到原始位置
//         _p.value = PaperPoint(
//             Point(
//               widget.currentA.x + (size.width - widget.currentA.x) * _controller!.value,
//               widget.currentA.y + (size.height - widget.currentA.y) * _controller!.value,
//             ),
//             size);
//       }
...
//           // print("翻页2222");
//           setState(() {
//             widget.isAlPath = true;
//             widget.controller.currentIndex++;
//             widget.nextCallBack?.call(widget.controller.currentIndex + 1);
//             print(
//                 "is Exccedded ${widget.controller.currentIndex >= widget.pageCount}");
//             if (widget.controller.currentIndex >= widget.pageCount) {
//               pageNo.value = 0;
//             } else {
//               pageNo.value = widget.controller.currentIndex;
//             }
//           });
//         }
//       }
...
//               clipper: widget.isAlPath ? null : CurrentPaperClipPath(_p, widget.isNext),
//             ),
//
//             CustomPaint(
//               size: size,
...
//             return;
//           }
//           if (widget.isAlPath == true) {
//             setState(() {
//               widget.isAlPath = false;
//             });
//           }
//           if (downPos.dy > size.height / 3 &&
//               downPos.dy < size.height * 2 / 3) {
//             // 横向翻页
//             widget.currentA = Point(move.dx, size.height - 1);
//             _p.value = PaperPoint(Point(move.dx, size.height - 1), size);
//           } else {
//             // 右下角翻页
//             widget.currentA = Point(move.dx, move.dy);
...
//       widget.isAlPath = false;
//       widget.isAnimation = true;
//       widget.currentA = Point(-200, size.height - 100);
//       widget.controller.currentIndex--;
//       pageNo.value = widget.controller.currentIndex;
//       widget.isNext = false;
//       _controller?.forward(
...
//     widget.isAnimation = true;
//     widget.isNext = true;
//     widget.currentA = Point(size.width - 50, size.height - 50);
//     _controller?.forward(
//       from: 0,
//     );
//   }
