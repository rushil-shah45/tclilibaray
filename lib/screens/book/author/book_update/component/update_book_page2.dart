...
class UpdateBookPageTwo extends StatelessWidget {
  const UpdateBookPageTwo({super.key});
            ...
            sliver: SliverToBoxAdapter(
              child: Column(
                ...
                children: [
                  ...
                  if(controller.bookType.value == "pdf")
                    Column(
                      ...
                      children: [
                        ...
                        const CustomRichText(title: 'Reading Time (In Hours) ', star: "*"),
                        SizedBox(
                          width: Get.width,
                          child: TextField(
                  ...
                  SizedBox(height: 15.h),
                  const CustomRichText(title: 'Book Distribution ',star: "*",),
                  Container(
                    height: Get.height / 16.7,
                    decoration: BoxDecoration(
                      color: Colors.white,
                    ...
                    alignment: Alignment.centerLeft,
                    child: Obx(() {
                      List<String> items = controller.distributionTypeList.value;
                      return DropdownButton(
                        borderRadius: BorderRadius.circular(10.r),
                        padding: const EdgeInsets.symmetric(horizontal: 10),
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(child: Text(controller.bookPriceController.text.isEmpty
                      ...
                      Obx(
                        () => controller.booksStoreLoading.value
                            ...
                            : CustomBtn(
                                ...
                                text: 'Update',
                                callback: () {
                                  controller.newBookUpdate(context);
                                },
                              ),
                      ),
                    ],
