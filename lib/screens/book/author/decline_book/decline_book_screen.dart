...
class DeclineBookScreen extends StatelessWidget {
  const DeclineBookScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<DeclineBookController>(builder: (controller) {
      return Scaffold(
        appBar: AppBar(
          leading: IconButton(
              onPressed: () {
                          ...
                          SliverPadding(
                            ...
                            sliver: SliverList(
                              delegate: SliverChildBuilderDelegate(
                                childCount: controller.booksModel!.books.length,
                                (context, index) {
                                  return Container(
                                    padding: const EdgeInsets.all(10),
                                    decoration: BoxDecoration(
