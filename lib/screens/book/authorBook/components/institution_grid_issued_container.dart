...
class InstitutionGridIssuedContainer extends StatefulWidget {
  const InstitutionGridIssuedContainer({super.key, required this.controller});

  final AuthorBookController controller;

  @override
  State<InstitutionGridIssuedContainer> createState() => _InstitutionGridIssuedContainerState();
}

class _InstitutionGridIssuedContainerState extends State<InstitutionGridIssuedContainer> {
  @override
                                      ...
                                      child: Column(
                                        children: [
                                          Container(
                                            ...
                                            //           .packageId !=
                                            //           '1'))
                                            //       ? (issued.isBorrowed == false)
                                            //           ? Icons.lock_open
                                            //           : ((issued.borrowedStartdate !=
                                            //                           "" &&
