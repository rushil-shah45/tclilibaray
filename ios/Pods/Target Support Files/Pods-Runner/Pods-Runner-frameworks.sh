...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ScreenProtectorKit/ScreenProtectorKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/pdf_image_renderer/pdf_image_renderer.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/screen_protector/screen_protector.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/syncfusion_flutter_pdfviewer/syncfusion_flutter_pdfviewer.framework"
